...
classDiagram
    direction TB
        class User {
            ...
            -userRole: String
            -salary: double
            +User(id: int, fname: String, lname: String, phone: String, email: String, password: String, role: String, salary: double)
            +getId() int
            +getFName() String
            ...
            +updateInfo(fname: String, lname: String, phone: String, email: String, password: String, role: String, salary: double) void
        }

        class Admin {
            +addEmployee() void
            +updateEmployee(id: int, e: Employee) void
        ...
        class Inventory {
            ...
            +Inventory(id: int, fname: String, lname: String, phone: String, email: String, password: String, role: String, salary: double)
        ...
        class Order {
            ...
            +Order(seller: Sales)
            +addItem(p: Product, quantity: int) void
        ...
        class Employee {
            -department: String
            +Employee(department: String, id: int, fname: String, lname: String, phone: String, email: String, password: String, role: String, salary: double)
            +getDepartment() String
            +setDepartment(dept: String) void
        }

        class Sales {
            +Sales(id: int, fname: String, lname: String, phone: String, email: String, password: String, role: String, salary: double)
            +makeOrder() void
        ...
        class Marketing {
            -offers: List
            +Marketing(id: int, fname: String, lname: String, phone: String, email: String, password: String, role: String, salary: double)
            +makeReport() void
